...
const { user: userOrder } = require('./order.fixture');
...
const userOrderAccessToken = tokenService.generateToken(userOrder._id, accessTokenExpires, tokenTypes.ACCESS);
